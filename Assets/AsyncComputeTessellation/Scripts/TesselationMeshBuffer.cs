...
{
    internal unsafe class TesselationMesh : IDisposable
    {
        private Mesh _mesh;
        ...
        public TesselationMesh(Mesh mesh)
        {
            _mesh = mesh;

            _vertexBuffer = new ComputeBuffer(_mesh.vertexCount, sizeof(Vertex), ComputeBufferType.Structured);
